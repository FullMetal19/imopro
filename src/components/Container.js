    ...
    return (
      ...
      <div className="d-flex flex-column bg-white my-2 shadow-sm border rounded-2">
        ...
        <div className="d-flex gap-3 p-3">
          {
              data?.media[1] ? ( <img src={ data?.media[1]?.path } className="rounded" alt="image-int-1" style={{ width: "80px", height: "60px", objectFit: "cover" }} /> ) : ( <span className="border rounded bg-light" style={{ width: "80px", height: "60px", objectFit: "cover" }}></span>  )
          }
          {
              data?.media[2] ? ( <img src={ data?.media[2]?.path } className="rounded" alt="image-int-2" style={{ width: "80px", height: "60px", objectFit: "cover" }} /> ) : ( <span className="border rounded bg-light" style={{ width: "80px", height: "60px", objectFit: "cover" }}></span>  )
          } 
        </div>
        {/* Contenu */}
