          ...
          <div className="row h-100 d-flex align-items-center ps-4" >
            <div className="col-md-10 d-flex flex-column p-4" >
              <div className="d-flex align-items-center  mb-3" >
                <span className="d-flex align-items-center justify-content-center bg-light px-4 py-2 rounded-2 shadow-sm"> <i class="bi bi-house-door-fill fs-3 text-blue-clr"></i> </span>
              </div>
