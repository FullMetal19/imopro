            ...
            <form className="d-flex flex-column px-2">
                <div className="d-flex flex-column mb-3">  
                    <div className="d-flex flex-column mb-2">  
                        ...
                        <select className="border w-100 px-2 py-3 text-muted rounded-2" value={country} name="country" required onChange={ handleInputs } >
                    ...
                    <div className="d-flex flex-column mb-2">  
                        ...
                        <select className="border w-100 px-2 py-3 text-muted rounded-2" value={region} name="region" required onChange={ handleInputs } >
                ...
                <div className="d-flex flex-column mb-3">  
                    <span className="text-secondary fs-xs mb-1"> Filter par type de propriété </span>
                    <select className="border w-100 px-2 py-3 text-muted rounded-2" value={houseType} name="houseType" onChange={(e) => setHouseType(e.target.value)} >
