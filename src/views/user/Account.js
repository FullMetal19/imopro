                              ...
                              <div className="row mt-4">
                                  ...
                                  <div className="col-lg-12 mb-4 px-0"> 
                                      <div className="d-flex"> 
                                          <button className={`bouton text-secondary py-2 ${ btnstate ? 'border-top border-start border-end bg-light rounded-top-3' : 'border-bottom' }`} onClick={ ()=>{ setBtnstate(true) } } > Mes rendez-vous </button>  
                                          <button className={`bouton text-secondary py-2 ${ btnstate ? 'border-bottom' : 'border-top border-start border-end bg-light rounded-top-3' }`} onClick={ ()=>{ setBtnstate(false) } } > Mes locations </button>
