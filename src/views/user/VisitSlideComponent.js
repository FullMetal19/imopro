      ...
      <div className="row px-4 py-5">
        {isLoading ? (
          <div className="col-md-12 d-flex justify-content-center">
            <div
              className="spinner-border text-blue-clr fs-1"
              role="status"
              ...
              <div className="d-flex flex-column shadow-sm bg-white rounded-3 border">
                ...
                <div className="d-flex justify-content-between bg-three-clr px-3 py-3">
                  <button
                    ...
                    onClick={() =>
                      openLocalisationModal(item.Property.longitude, item.Property.latitude)
                    }
                  >
                  ...
                  {item.Property.isbooked === 1 ? (
                    ...
                    <button
                      className="btn btn-sm btn-outline-secondary"
                      onClick={() =>
                        openValidationModal(item.Property.guaranty, item.Property.id)
                      }
                    >
